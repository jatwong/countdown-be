...
INSTALLED_APPS = [
    ...
    "countdowndate.apps.CountdownDateConfig",
...
DATABASES = {
    "default": {
        ...
        "NAME": env.str("PG_NAME", default=""),
        "USER": env.str("PG_USER", default=""),
        "PASSWORD": env.str("PG_PASSWORD", default=""),
        "HOST": env.str("PG_HOST", default=""),
        "PORT": env.str("PG_PORT", default=""),
    }
}
